...
<div class="flex h-full">
    @include('layout.sidebar')
        ...
        <div class=" w-full h-screen">
            <div class="flex m-7 pb-7 gap-5 h-[10px]">
                ...
                <h3 class="font-bold text-[20px]  ">Mengubah Data SIswa</h3>
            </div>
            <form action="{{ route('siswa.update', $siswa->nis_siswa) }}" method="post"
                class="m-5  grid grid-cols-2 gap-5 ">
                @csrf
                @method('PUT')
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" id="nis_siswa" name="nis_siswa" value="{{ $siswa->nis_siswa }}"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" id="nisn_siswa" name="nisn_siswa" value="{{ $siswa->nisn_siswa }}"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required />
                    <label for="floating_password"
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" id="tempat_lahir_siswa" name="tempat_lahir_siswa"
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="date" id="tanggal_lahir_siswa" name="tanggal_lahir_siswa"
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" id="kelurahan_siswa" name="kelurahan_siswa"
                        value="{{ $siswa->kelurahan_siswa }}"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required />
                    <label for="floating_password"
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" id="kecamatan_siswa" name="kecamatan_siswa"
                        value="{{ $siswa->kecamatan_siswa }}"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required />
                    <label for="floating_password"
                ...
                <div class="relative  w-full mb-5 group text-gray-500">
                    <label for="kelas" id="kelas_siswa" value="{{ $siswa->kelas_siswa }}"
                        class="  mb-2 text-sm font-medium text-gray-500 "></label>
                    <select name="kelas_siswa"
                        ...
                        <option selected >{{ $siswa->kelas_siswa }}</option>
